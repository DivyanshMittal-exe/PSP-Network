...
int main(int argc, char *argv[])
{
    ...
    std::string proto_ = "Veno";
    std::string protocol_type = "ns3::Tcp" + proto_;


    Config::SetDefault ("ns3::TcpL4Protocol::SocketType",  TypeIdValue (TypeId::LookupByName(protocol_type)));
    ...
    Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream("task_1_" + proto_ + ".dat");
    ns3TcpSocket->TraceConnectWithoutContext("CongestionWindow", MakeBoundCallback(&CwndChange, stream));

    PcapHelper pcapHelper;
    Ptr<PcapFileWrapper> file = pcapHelper.CreateFile("task_1_" + proto_ + ".pcap", std::ios::out, PcapHelper::DLT_PPP);
    ...
    fileHelper.ConfigureFile("task_1_" + proto_ + "-packet-byte-count",
